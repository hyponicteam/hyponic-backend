...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <h1 class="mt-4">Video Categories</h1>
                <a href="/video-categories/create" class="btn btn-success">Create New Data</a>
                ...
                <table class="table table-borderless">
                    ...
                    <tbody>
                        @foreach ($categories as $category)
                            <tr>
                                <td class="fit"><a
                                        href="/video-categories/{{ $category['id'] }}">{{ $category['name'] }}</a>
                                </td>
                                <td class="fit"><a href="/video-categories/{{ $category['id'] }}/edit"
